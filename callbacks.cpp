...
void callbacks::ToggleCrimWalk() {
	g_aimbot.m_crimwalk = !g_aimbot.m_crimwalk;
}
...
void callbacks::ConfigLoad1() {
	...
	g_config.load(&g_menu.main, XOR("1.neb"));
...
void callbacks::ConfigLoad2() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("2.neb"));
...
void callbacks::ConfigLoad3() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("3.neb"));
...
void callbacks::ConfigLoad4() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("4.neb"));
...
void callbacks::ConfigLoad5() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("5.neb"));
...
void callbacks::ConfigLoad6() {
	g_aimbot.m_fake_latency = false;
	g_config.load(&g_menu.main, XOR("6.neb"));
...
void callbacks::ConfigLoad() {
	...
	std::string file = tfm::format(XOR("%s.neb"), config.data());
