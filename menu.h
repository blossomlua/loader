...
public:
	void init() {
		...
		penetrate.setup(XOR("autowall"), XOR("penetrate"));
		...
		override.setup(XOR("override minimum damage key"), XOR("override"));
...
public:
	void init() {
		...
		crimwalk.setup(XOR("crim walk (hold-e)"), XOR("crimwalk"));
		//crimwalk.SetToggleCallback(callbacks::ToggleCrimWalk);
		RegisterElement(&crimwalk, 1);
