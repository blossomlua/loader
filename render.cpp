...
void render::init() {
	menu = Font(XOR("Anton"), 12, FW_NORMAL, FONTFLAG_NONE);
	menu_shade = Font(XOR("Anton"), 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
	esp = Font(XOR("Anton"), 12, FW_NORMAL, FONTFLAG_DROPSHADOW);
	esp_small = Font(XOR("Small Fonts"), 8, FW_NORMAL, FONTFLAG_OUTLINE);
	hud = Font(XOR("Anton"), 90, FW_NORMAL, FONTFLAG_ANTIALIAS);
	cs = Font(XOR("Counter-Strike"), 28, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	indicator = Font(XOR("Anton"), 26, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
